...
--unit: Killer (highlight unit name and change to desired unit)
...
skillPointText = game:GetService("Players").LocalPlayer.PlayerGui.BuffInterFace.BuffSelection.SkillPoint.Text
